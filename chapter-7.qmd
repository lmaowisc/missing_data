...
:::: book-figure
<img alt="The triad of missing data, observed data, and parameter. Red arrow: imputing the missing data depends on the observed data and the parameter; blue arrow: estimating/drawing the parameter depends on the full data, i.e., observed and missing data." src="figures/review0.png"/>
...
:::: book-figure
<img alt="The Gibbs sampler solution to the “three-body” problem. GS A: \([D_{\mathrm{mis}}\mid D_{\mathrm{obs}};\theta]\) ; GS B: \([\theta\mid D_{\mathrm{obs}}, D_{\mathrm{mis}}]\) ." src="figures/review2.png"/>
...
:::: book-figure
<img alt="Break out of the “three-body” system by using a convenient (uncongenial) imputation model, where model parameters can be easily estimated based on observed data and the posterior predictive distributions have closed forms." src="figures/review3.png"/>
