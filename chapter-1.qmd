...
::::: book-figure
<img alt="An illustration of identifiability under MAR. Black indicates observed; hollow indicates missing. The information contained in the right halves of the half-filled circles can be inferred based on the fully-filled circles, because the latter are a representative sample of the subpopulation." src="figures/MARid.png"/>
...
:::: book-figure
<img alt="Left column: full data distributions; right column: observed data distributions. A: missing at random; B and C: not missing at random." src="figures/normalid.png"/>
